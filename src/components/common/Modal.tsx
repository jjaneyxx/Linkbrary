...
const Modal = () => {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-black/50" onClick={handleModalClose}>
      <div className="absolute top-1/2 left-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 transform flex-col items-center rounded-[15px] border border-[#CCD5E3] bg-white px-10 py-8">
